...
player #= pygame.image.load('bonus.png').convert_alpha()
#layer.fill(COLOR_BLACK)
...
CHANGE_IMAG = pygame.USEREVENT + 3
pygame.time.set_timer(CHANGE_IMAG, 200)
